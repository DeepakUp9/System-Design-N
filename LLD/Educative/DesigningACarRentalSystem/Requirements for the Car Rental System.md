...
<span style="background-color: yellow; color: blue;">in depth(Requirements for the Car Rental System), <a href="./deapth/RequirementsfortheCarRentalSystem.md">click here</a></span>
package DesignPattern.behaviouralPattern.templateMethod.thirdResource.AmazonOrderProcesser;

// Abstract class representing the template for order processing
abstract class OrderProcessingTemplate {
    public void processOrder() { //make it this method final so that no one can override using keyword final
        verifyOrder();
        assignDeliveryAgent();
        trackDelivery();
    }
